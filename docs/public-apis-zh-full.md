...
| 序号 | 分类（中文） | 英文原名 | API数量 | 用途简述 |
|:---:|:-----------|:--------|:------:|---------|
| 1 | 动物 | Animals | 27 个 | 适合宠物类App开发、动物识别项目、动物科普网站等场景。 |
| 2 | 动漫 | Anime | 19 个 | 适合动漫社区、追番工具、动漫图站等应用开发。 |
| 3 | 反恶意软件 | Anti-Malware | 15 个 | 安全防护类接口等接口。 |
| 4 | 艺术与设计 | Art & Design | 22 个 | 艺术创作与设计类接口等接口。 |
| 5 | 认证与授权 | Authentication & Authorization | 7 个 | 身份认证与授权服务接口等接口。 |
| 6 | 区块链 | Blockchain | 13 个 | 区块链数据接口等接口。 |
| 7 | 书籍 | Books | 27 个 | 图书数据接口等接口。 |
| 8 | 商业 | Business | 25 个 | 商业数据接口等接口。 |
| 9 | 日历 | Calendar | 18 个 | 日历相关接口等接口。 |
| 10 | 云存储与文件共享 | Cloud Storage & File Sharing | 18 个 | 云存储与文件共享服务接口等接口。 |
| 11 | 持续集成 | Continuous Integration | 6 个 | CI/CD相关接口等接口。 |
| 12 | 加密货币 | Cryptocurrency | 65 个 | 加密货币数据接口等接口。 |
| 13 | 货币汇率 | Currency Exchange | 18 个 | 货币汇率接口等接口。 |
| 14 | 数据验证 | Data Validation | 7 个 | 数据验证接口等接口。 |
| 15 | 开发工具 | Development | 132 个 | 最实用的开发工具集合，包括IP地理位置查询、User-Agent解析、UUID生成、代码片段管理、颜色转换等日常开发必备工具接口。 |
| 16 | 字典 | Dictionaries | 13 个 | 词典接口等接口。 |
| 17 | 文档与生产力 | Documents & Productivity | 34 个 | 文档与效率工具接口等接口。 |
| 18 | 电子邮件 | Email | 20 个 | 邮件服务接口等接口。 |
| 19 | 娱乐 | Entertainment | 16 个 | 娱乐类接口等接口。 |
| 20 | 环境 | Environment | 18 个 | 环境数据接口等接口。 |
| 21 | 活动 | Events | 3 个 | 活动事件接口等接口。 |
| 22 | 金融 | Finance | 51 个 | 适合理财App、股票分析工具、金融数据可视化等开发。 |
| 23 | 美食与饮品 | Food & Drink | 25 个 | 美食类接口等接口。 |
| 24 | 游戏与漫画 | Games & Comics | 97 个 | 适合游戏社区、游戏辅助工具、漫画阅读器等开发。 |
| 25 | 地理编码 | Geocoding | 92 个 | 地图与位置服务核心接口，支持地址解析、逆地址解析、行政区划查询、周边搜索等功能。 |
| 26 | 政府数据 | Government | 95 个 | 各国政府开放数据，包括美国、英国、法国、印度等多个国家的政府公开数据接口，适合数据分析和公共服务项目开发。 |
| 27 | 健康 | Health | 35 个 | 适合健康管理App、医疗信息查询、健身指导等大健康领域应用开发。 |
| 28 | 招聘 | Jobs | 20 个 | 招聘求职接口等接口。 |
| 29 | 机器学习 | Machine Learning | 28 个 | 适合AI应用开发，提供预训练模型API，可直接调用的AI能力包括图像识别、语音合成、文本分析等。 |
| 30 | 音乐 | Music | 35 个 | 适合音乐播放器、歌词展示、音乐推荐等应用开发。 |
| 31 | 新闻 | News | 20 个 | 新闻接口等接口。 |
| 32 | 开放数据 | Open Data | 42 个 | 开放数据接口等接口。 |
| 33 | 开源项目 | Open Source Projects | 9 个 | 开源项目相关接口等接口。 |
| 34 | 专利 | Patent | 4 个 | 专利数据接口等接口。 |
| 35 | 性格测试 | Personality | 25 个 | 性格测试接口等接口。 |
| 36 | 电话 | Phone | 6 个 | 手机相关接口等接口。 |
| 37 | 摄影 | Photography | 29 个 | 摄影类接口等接口。 |
| 38 | 编程 | Programming | 5 个 | 编程语言与开发工具接口等接口。 |
| 39 | 科学与数学 | Science & Math | 35 个 | 科学与数学接口等接口。 |
| 40 | 安全 | Security | 41 个 | 适合安全工具开发，包括漏洞扫描、威胁情报、SSL证书监控等安全相关的数据服务。 |
| 41 | 购物 | Shopping | 15 个 | 购物类接口等接口。 |
| 42 | 社交 | Social | 43 个 | 适合社交平台分析、内容聚合、社交媒体管理等工具开发。 |
| 43 | 体育与健身 | Sports & Fitness | 41 个 | 体育健身接口等接口。 |
| 44 | 测试数据 | Test Data | 27 个 | 测试数据接口等接口。 |
| 45 | 文本分析 | Text Analysis | 18 个 | 文本分析接口等接口。 |
| 46 | 追踪 | Tracking | 10 个 | 追踪类接口等接口。 |
| 47 | 交通 | Transportation | 74 个 | 适合出行App开发，包括航班实时状态、火车时刻表、公交线路规划、地铁数据、共享单车位置等出行相关的数据接口。 |
| 48 | 短链接 | URL Shorteners | 20 个 | 短链接服务接口等接口。 |
| 49 | 车辆 | Vehicle | 10 个 | 车辆数据接口等接口。 |
| 50 | 视频 | Video | 45 个 | 适合视频平台、直播工具、视频编辑等开发。 |
| 51 | Weather | Weather | 34 个 | 适合天气App、出行助手、农业气象等开发。 |
...
> 提供各种动物相关的数据接口，包括宠物信息、动物图片、 breeds 识别、动物救援等
> 💡 **适用场景**：适合宠物类App开发、动物识别项目、动物科普网站等场景。大部分接口无需认证即可使用。

| API | 描述 | 认证方式 | HTTPS | CORS |
|:----|:-----|:--------:|:----:|:----:|
...
> 动漫相关数据接口，涵盖动漫信息查询、角色资料、番剧进度、动漫图片等
> 💡 **适用场景**：适合动漫社区、追番工具、动漫图站等应用开发。包含日漫、国漫等各类动漫数据。
...
### 3. 反恶意软件（Anti-Malware）📌

> 安全防护类接口，提供恶意软件检测、域名黑名单查詢、威胁情报分析等功能
...
> 艺术创作与设计类接口，包括颜色方案生成、字体识别、图形处理、设计资源等
...
> 区块链数据接口，包含地址查询、交易记录、节点信息、NFT数据等
...
> 图书数据接口，提供图书信息查询、ISBN检索、书评、图书馆藏等
...
> 商业数据接口，涵盖公司信息查询、工商注册、商业信用、行业数据等
...
> 日历相关接口，提供节假日查询、日期计算、日程管理、时区转换等
...
### 10. 云存储与文件共享（Cloud Storage & File Sharing）📌

> 云存储与文件共享服务接口，支持文件上传下载、分享链接等
...
### 12. 加密货币（Cryptocurrency）📌

> 加密货币数据接口，提供实时行情、历史价格、交易所数据、DeFi信息等
...
### 13. 货币汇率（Currency Exchange）📌

> 货币汇率接口，提供实时汇率、历史汇率、货币转换等
...
### 14. 数据验证（Data Validation）📌

> 数据验证接口，提供邮箱验证、手机号验证、身份证验证等
...
> 开发工具类接口，涵盖IP查询、User-Agent解析、代码格式化、随机数据生成等
> 💡 **适用场景**：最实用的开发工具集合，包括IP地理位置查询、User-Agent解析、UUID生成、代码片段管理、颜色转换等日常开发必备工具接口。大部分免费且无需认证。
...
### 17. 文档与生产力（Documents & Productivity）📌

> 文档与效率工具接口，提供PDF处理、文档转换、OCR识别等
...
> 金融数据接口，提供股票行情、基金信息、财务报表、经济指标等
> 💡 **适用场景**：适合理财App、股票分析工具、金融数据可视化等开发。提供实时行情和历史数据。
...
### 24. 游戏与漫画（Games & Comics）📌

> 游戏与漫画接口，提供游戏数据、角色信息、漫画更新、游戏资讯等
> 💡 **适用场景**：适合游戏社区、游戏辅助工具、漫画阅读器等开发。包含游戏角色数据、游戏资讯、漫画章节等。
...
> 地理编码接口，提供地址转坐标、坐标转地址、地图数据、位置搜索等
> 💡 **适用场景**：地图与位置服务核心接口，支持地址解析、逆地址解析、行政区划查询、周边搜索等功能。适合导航App、本地生活服务、地理数据分析等场景。
...
> 政府开放数据接口，各政府机构提供的公开数据服务
> 💡 **适用场景**：各国政府开放数据，包括美国、英国、法国、印度等多个国家的政府公开数据接口，适合数据分析和公共服务项目开发。
...
> 健康医疗接口，提供药品信息、疾病数据、营养建议、医保服务等
> 💡 **适用场景**：适合健康管理App、医疗信息查询、健身指导等大健康领域应用开发。
...
> 机器学习接口，提供AI模型调用、图像识别、NLP、语音处理等
> 💡 **适用场景**：适合AI应用开发，提供预训练模型API，可直接调用的AI能力包括图像识别、语音合成、文本分析等。
...
> 音乐接口，提供歌曲搜索、歌词、播放列表、音乐识别等
> 💡 **适用场景**：适合音乐播放器、歌词展示、音乐推荐等应用开发。支持主流音乐平台数据获取。
...
### 33. 开源项目（Open Source Projects）📌

> 开源项目相关接口，提供项目数据、贡献统计等
...
### 39. 科学与数学（Science & Math）📌

> 科学与数学接口，提供天文数据、物理常数、数学计算等
...
> 安全类接口，提供漏洞信息、SSL证书检查、安全评分等
> 💡 **适用场景**：适合安全工具开发，包括漏洞扫描、威胁情报、SSL证书监控等安全相关的数据服务。
...
> 社交媒体接口，提供社交平台数据、内容聚合、社交分析等
> 💡 **适用场景**：适合社交平台分析、内容聚合、社交媒体管理等工具开发。包含主流平台数据接口。
...
### 43. 体育与健身（Sports & Fitness）📌

> 体育健身接口，提供赛事数据、运动记录、健身指导等
...
### 45. 文本分析（Text Analysis）📌

> 文本分析接口，提供情感分析、关键词提取、文本分类等
...
### 47. 交通（Transportation）📌

> 交通出行接口，提供航班查询、公交地铁、路况信息等
> 💡 **适用场景**：适合出行App开发，包括航班实时状态、火车时刻表、公交线路规划、地铁数据、共享单车位置等出行相关的数据接口。
...
### 48. 短链接（URL Shorteners）📌

> 短链接服务接口，提供长链接转短链接、链接统计等
...
> 视频类接口，提供视频信息、直播数据、视频处理等
> 💡 **适用场景**：适合视频平台、直播工具、视频编辑等开发。支持热门视频平台的数据获取。
...
> 提供。
> 💡 **适用场景**：适合天气App、出行助手、农业气象等开发。支持全球天气数据和空气质量查询。
